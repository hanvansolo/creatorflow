...
export const en: Dictionary = {
  ...
  about: {
    ...
    intro: 'Footy Feed is your complete football hub — breaking news, live scores, AI-powered predictions, and in-depth tactical analysis from across world football.',
    builtBy: 'Built by fans, for fans. We cut through the noise to bring you only what matters.',
    whatWeOffer: 'What We Offer',
    featNewsTitle: 'Breaking News',
    featNewsDesc: 'The latest football headlines as they happen, written by our editorial team and published around the clock.',
    ...
    sourcesBlurb: 'Our reporting draws on information from leading football publications:',
    disclaimer: 'Disclaimer',
    disclaimerBody: 'Footy Feed is an independent football news publication. We are not affiliated with FIFA, UEFA, any football league, club, or player. All trademarks and content belong to their respective owners.',
  },
  contact: {
    heading: 'Contact Us',
